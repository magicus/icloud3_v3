...
more_info_text = {
    ...
    'mobapp_error_search_msg': (
        ...
        f"Settings > Devices” screen and delete or rename the devices starting with the "
        f"iCloud3 devicename that should be selected."),

    'mobapp_error_disabled_msg': (
        f"{CRLF_DASH_75}"
        f"{CRLF}1. Go to “HA Devices & Settings > Integrations > Mobile App”"
    ...
    'mobapp_error_multiple_devices_on_scan': (
        ...
        f"Settings > Devices” screen. Delete or rename the devices starting with the "
    ...
    'mobapp_device_unavailable': (
        ...
        f"and Settings > Integrations”). Check to see if a `Failed to set up` error message is "
    ...
    'mobapp_device_no_location': (
        ...
        f"and Settings > Integrations”). Check to see if an error message is displayed in general "
