...
def encode_all_passwords():
    ...
    for apple_account in Gb.conf_apple_accounts:
        apple_account[CONF_PASSWORD] = \
                            encode_password(apple_account[CONF_PASSWORD])
...
def decode_all_passwords():
    ...
    try:
        for apple_account in Gb.conf_apple_accounts:
            Gb.PyiCloud_password_by_username[apple_account[CONF_USERNAME]] = \
                decode_password(apple_account[CONF_PASSWORD])
