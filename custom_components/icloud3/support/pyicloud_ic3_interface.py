...
def create_all_PyiCloudServices():
    ...
    Gb.startup_lists['PyiCloud_by_username']       = Gb.PyiCloud_by_username
    Gb.startup_lists['_.username_valid_by_username'] = Gb.username_valid_by_username
    Gb.startup_lists['_.username_pyicloud_503_connection_error'] = Gb.username_pyicloud_503_connection_error
...
def display_authentication_msg(PyiCloud):
    ...
    event_msg =(f"Apple Acct Auth "
                f"#{PyiCloud.authentication_cnt} > {authentication_method}")
