...
class GlobalVariables(object):
    ...
    one_apple_account_flag       = True    # True if only 1 apple account, False if multipla apple accounts
    multi_apple_accounts_flag    = False   # False if only 1 apple account, True if multipla apple accounts
    username                     = ''
    username_base                = ''
    password                     = ''
