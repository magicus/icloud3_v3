...
async def async_setup_entry(hass: HomeAssistant, entry: ConfigEntry):
    ...
    try:
        ...
        await Gb.hass.async_add_executor_job(restore_state.load_storage_icloud3_restore_state_file)
        ...
        if Gb.use_data_source_ICLOUD:
            ...
            Gb.hass.async_add_executor_job(pyicloud_ic3_interface.create_all_PyiCloudServices)
